...
struct ContentView: View {
    ...
    var body: some View {
        ...
        actionButtons
            ...
            .onChange(of: bluetoothManager.temperature) { _, _ in sensorDrivenUpdate() }
            .onChange(of: bluetoothManager.humidity) { _, _ in sensorDrivenUpdate() }
            .onChange(of: bluetoothManager.lightLevel) { _, _ in sensorDrivenUpdate() }
