...
struct StatsModal: View {
    ...
    var body: some View {
        ...
        .onAppear { loadData() }
        .onChange(of: bluetoothManager.humidity) { _, _ in loadData() }
        .onChange(of: bluetoothManager.temperature) { _, _ in loadData() }
        .onChange(of: bluetoothManager.soilMoisture) { _, _ in loadData() }
        .onChange(of: bluetoothManager.lightLevel) { _, _ in loadData() }
    }
