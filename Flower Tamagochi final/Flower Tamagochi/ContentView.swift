...
struct ContentView: View {
    ...
    var body: some View {
        ...
        actionButtons
            ...
            .onChange(of: bluetoothManager.temperature) { _ in sensorDrivenUpdate() }
            .onChange(of: bluetoothManager.humidity) { _ in sensorDrivenUpdate() }
            .onChange(of: bluetoothManager.lightLevel) { _ in sensorDrivenUpdate() }
